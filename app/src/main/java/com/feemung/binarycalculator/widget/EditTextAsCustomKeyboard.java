 ...
 *
 */
public class EditTextAsCustomKeyboard extends EditText implements OnKeyboardActionListener {
	 ...
	 * @param attrs
	 */
	public EditTextAsCustomKeyboard(Context context, AttributeSet attrs) {
		super(context, attrs);
	 ...
	 * @param defStyle
	 */
	public EditTextAsCustomKeyboard(Context context, AttributeSet attrs, int defStyle) {
	...
	private void initKeyboard(Context context, AttributeSet attrs){
		...
		if(a.hasValue(R.styleable.keyboard_xml)){
			...
			mKeyboardView = (KeyboardView)LayoutInflater.from(context).inflate(R.layout.customkeyboardview, null);
